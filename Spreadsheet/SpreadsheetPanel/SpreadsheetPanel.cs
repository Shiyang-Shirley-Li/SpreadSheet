...
///     The other half is in the SpreadsheetPanel.Designer.cs file.  The Designer
...
namespace SS
{
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        private class DrawingPanel : Panel
        {
            ...
            /// <summary>
            /// tells whether or not the clicked location is an invalid address
            /// </summary>
            /// <param name="col">column of the selected location</param>
            /// <param name="row"> row of the selected location</param>
            /// <returns> whether or not the location clicked is invalid</returns>
            ...
            /// </summary>
            /// <param name="col"> column of the cell. determines the letter address</param>
            /// <param name="row"> row of the cell. determines the number from 1-99</param>
            /// <param name="c">the content being placed into the cell</param>
            /// <returns> if the cell whose contents we are setting is a valid cell</returns>
            ...
            /// <summary>
            /// gets the value from the cell : not sure if value or content
            /// </summary>
            /// <param name="col"> column of the cell. determines the letter address</param>
            /// <param name="row"> row of the cell. determines the number from 1-99</param>
            /// <param name="c">the contents/value of the cell? the name of the cell?</param>
            /// <returns> if the cell whose contents we are setting is a valid cell</returns>
            ...
            /// <summary>
            /// determines if the selected cells are valid cells to select.
            /// will occur twice: the selected row and column of the first cell, and the selected row and column of the opposite corner cell
            /// </summary>
            /// <param name="col">selected cell column</param>
            /// <param name="row"> selected cell row</param>
            /// <returns></returns>
            public bool SetSelection(int col, int row)
            {
                if (InvalidAddress(col, row))
            ...
            /// <summary>
            /// stores the row and column of the slected cell: used to reference a cell in a formula?
            /// </summary>
            /// <param name="col">selected cell column</param>
            /// <param name="row">selected cell row</param>
            public void GetSelection(out int col, out int row)
            ...
            /// <summary>
            /// Updates the visual representation to move horizontally: x-axis/letter of cell
            /// </summary>
            /// <param name="sender">the user selection on the scroller</param>
            /// <param name="args">the scrolling object</param>
            ...
            /// <summary>
            /// Updates the visual representation to move vertically: y-axis/number of cell
            /// </summary>
            /// <param name="sender">the user selection of the scroller</param>
            /// <param name="args">the scrolling object</param>
            ...
            /// <summary>
            /// Creates the spreadsheet and gives the graphic representation.
            /// Updates to bold the selected cell, as well as putting the value of of the cell in surrounding cells,
            /// as well as the contents of the cell in the selected cell.
            /// </summary>
            /// <param name="e">the object(the spreadsheet) being drawn</param>
